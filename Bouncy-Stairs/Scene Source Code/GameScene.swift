...
//        }
    ...
    func startGame() {
        ...
        stairCase = Staircase(frame: frame, with: ball)
        addChild(stairCase)
        
        print(frame.minX)
        
        // 
        secondStaircase = Staircase(frame: frame, with: ball, at: stairCase.frame.maxX + (stairCase.stairSize.width * 7))
        stairCase.addChild(secondStaircase)
