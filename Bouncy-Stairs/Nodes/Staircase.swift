...
class Staircase: SKNode {
    ...
    var stairSections = [SKNode]()
    var ball: Ball!
    
    
    init(frame: CGRect, with ball: Ball) {
        super.init()
        name = "stairCase"
    ...
    init(frame: CGRect, with ball: Ball, connectedTo stair: SKNode) {
        super.init()
        name = "stairCase"
        xPosition = stair.frame.maxX
        self.ball = ball
        createStaircase(at: xPosition)
    }
    
    init(frame: CGRect, with ball: Ball, at position: CGFloat) {
        super.init()
        name = "stairCase"
        xPosition = position
        self.ball = ball
